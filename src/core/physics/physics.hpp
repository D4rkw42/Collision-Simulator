...
const double ELASTIC_COEFFICIENT = 0.3f;

void BodyElasticCollision(double velX1, double velY1, double velX2, double velY2, double& accX1, double& accY1, double& accX2, double& accY2); // usado para calcular as novas velocidades de um corpo após uma colisão
